...
readonly staging="$RUNNER_TEMP/omp-v18.1.13-darwin-arm64.download"
readonly receipt_staging="$RUNNER_TEMP/omp-canary-cleanup-identity"
readonly expected='a4c5c9cc5b8222184d0d7429b0bb6ac2a92bbe45dd11bf68e4b1360050791909'
...
/usr/bin/curl --proto '=https' --proto-redir '=https' --tlsv1.2 \
  ...
  --output "$staging" \
  'https://github.com/can1357/oh-my-pi/releases/download/v18.1.13/omp-darwin-arm64'
