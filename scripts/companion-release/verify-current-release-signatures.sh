...
readonly COSIGN_IDENTITY='https://github.com/Insajin/autopus-adk/.github/workflows/release.yaml@refs/tags/v0.50.90'
...
# @AX:REASON [AUTO]: Release and recovery workflows must verify both the exact K1 envelope and the A19 GitHub Actions Sigstore identity before creating a tap write token.
...
printf 'current release signatures: exact A19 ECDSA and keyless signatures verified\n'
