...
readonly PRIOR_TAP_COMMIT='abe9d317503d4bd813328b438ee038b3aaf8767e'
readonly CASK_PATH='Casks/auto.rb'
readonly PRIOR_CASK_BLOB='565e37d88837df90557a36d7b5f840b699731bbc'
...
publish_cask cask Cask "$CASK_PATH" "$cask_target" "$PRIOR_CASK_BLOB" \
  'Publish signed Cask for v0.50.90' \
  'published Cask differs from canonical v0.50.89 output and its pinned prior blob'
