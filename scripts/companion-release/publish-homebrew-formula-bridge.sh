...
readonly PRIOR_TAP_COMMIT='957834c5fdefad2b14ba0c8644323888c5055483'
readonly CASK_PATH='Casks/auto.rb'
readonly PRIOR_CASK_BLOB='02e7750314f10a7283c85b66d567b8f283439e48'
...
publish_cask cask Cask "$CASK_PATH" "$cask_target" "$PRIOR_CASK_BLOB" \
  'Publish signed Cask for v0.50.108' \
  'published Cask differs from canonical v0.50.108 output and its pinned prior blob'
