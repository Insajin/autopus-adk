...
readonly PRIOR_TAP_COMMIT='d0292d235fd351b1e5f2bcbf5aef213610587e3f'
readonly CASK_PATH='Casks/auto.rb'
readonly PRIOR_CASK_BLOB='adce0d92445ca7e39c5afa50c6636d06149cf5ea'
...
publish_cask cask Cask "$CASK_PATH" "$cask_target" "$PRIOR_CASK_BLOB" \
  'Publish signed Cask for v0.50.86' \
  'published Cask differs from canonical v0.50.85 output and its pinned prior blob'
