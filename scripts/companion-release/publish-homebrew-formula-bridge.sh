...
readonly PRIOR_TAP_COMMIT='ab9a0e489ee34f8a075019c4acebb2a8ae61c290'
readonly CASK_PATH='Casks/auto.rb'
readonly PRIOR_CASK_BLOB='c6edb108d821d88914e12d2c1bf943540c63351e'
...
publish_cask cask Cask "$CASK_PATH" "$cask_target" "$PRIOR_CASK_BLOB" \
  'Publish signed Cask for v0.50.82' \
  'published Cask differs from canonical v0.50.81 output and its pinned prior blob'
