...
v0.50.94 0.50.94 A22
CASES

for mismatch in 'v0.50.93 0.50.93' 'v0.50.92 0.50.91' 'v0.50.91 0.50.92' 'v0.50.94 0.50.92' 'v0.50.92 0.50.94'; do
...
assert_gate_failure() {
  ...
  if output=$(COMPANION_PLATFORM=darwin COMPANION_ARTIFACT="$temp/auto" \
    ...
    COMPANION_VERSION=0.50.94 bash "$temp/produce.sh" 2>&1); then
