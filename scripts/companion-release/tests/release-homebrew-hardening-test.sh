...
{
  printf '%064d  autopus-adk_0.50.105_darwin_amd64.tar.gz\n' 1
  printf '%064d  autopus-adk_0.50.105_darwin_arm64.tar.gz\n' 2
  printf '%064d  autopus-adk_0.50.105_linux_amd64.tar.gz\n' 3
  printf '%064d  autopus-adk_0.50.105_linux_arm64.tar.gz\n' 4
} >"$checksums"
