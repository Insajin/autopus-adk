...
{
  printf '%064d  autopus-adk_0.50.96_darwin_amd64.tar.gz\n' 1
  printf '%064d  autopus-adk_0.50.96_darwin_arm64.tar.gz\n' 2
  printf '%064d  autopus-adk_0.50.96_linux_amd64.tar.gz\n' 3
  printf '%064d  autopus-adk_0.50.96_linux_arm64.tar.gz\n' 4
} >"$checksums"
...
bridge_env=(PATH="$temp/bin:$PATH" MOCK_TAP_STATE="$state" GITHUB_REF_NAME=v0.50.96
  COMPANION_VERSION=0.50.96 COMPANION_HOMEBREW_POLICY=cask-only
