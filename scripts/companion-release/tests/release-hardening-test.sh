...
contains "$homebrew_bridge" "readonly PRIOR_TAP_COMMIT='a2c3e07311b216927225f27d8e7c6f46899cd85c'"
contains "$homebrew_bridge" "readonly PRIOR_CASK_BLOB='d694773024a3a0a6719a925b36e809fc9c28f402'"
...
contains "$release" "- 'v0.50.89'"
contains "$release" "if: github.ref == 'refs/tags/v0.50.89'"
contains "$recovery" "if: github.ref == 'refs/tags/v0.50.89'"
contains "$recovery" 'gh workflow run homebrew-formula-bridge-recovery.yaml --ref v0.50.89'
not_contains "$release" "'v0.50.88'"
not_contains "$release" 'refs/tags/v0.50.88'
not_contains "$recovery" 'refs/tags/v0.50.88'
...
contains "$producer_receipt" "GITHUB_REF_NAME\" == 'v0.50.89'"
contains "$producer_receipt" "release_phase='A18'"
contains "$homebrew_bridge" "readonly RELEASE_TAG='v0.50.89'"
contains "$homebrew_bridge" "readonly RELEASE_VERSION='0.50.89'"
...
contains "$current_release_gate" "readonly RELEASE_TAG='v0.50.89'"
contains "$current_release_gate" "readonly RELEASE_VERSION='0.50.89'"
