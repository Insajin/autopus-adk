...
contains "$tag_ruleset_gate" "ruleset_name='autopus-v0.50.117-release-authority'"
contains "$tag_ruleset_gate" "release_ref='refs/tags/v0.50.117'"
...
contains "$release" "- 'v0.50.117'"
contains "$release" "if: github.ref == 'refs/tags/v0.50.117'"
contains "$recovery" "if: github.ref == 'refs/tags/v0.50.117'"
...
contains "$release" "'autopus-adk_0.50.117_darwin_amd64.tar.gz'"
contains "$release" "'autopus-adk_0.50.117_darwin_arm64.tar.gz'"
...
contains "$homebrew_bridge" "readonly RELEASE_TAG='v0.50.117'"
contains "$homebrew_bridge" "readonly RELEASE_VERSION='0.50.117'"
...
contains "$current_release_gate" "readonly RELEASE_TAG='v0.50.117'"
contains "$current_release_gate" "readonly RELEASE_VERSION='0.50.117'"
...
contains "$current_release_gate" 'exactly fifteen A28 normal release assets verified'
for workflow in "$release" "$recovery"; do
