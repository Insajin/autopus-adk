...
contains "$homebrew_bridge" "readonly PRIOR_TAP_COMMIT='f62ca4883c8770104291185bc30184aa5fb1af50'"
contains "$homebrew_bridge" "readonly PRIOR_CASK_BLOB='557205adaae7c5e6b12ac1f9bc8346e00ed42a75'"
...
contains "$release" "- 'v0.50.88'"
contains "$release" "if: github.ref == 'refs/tags/v0.50.88'"
contains "$recovery" "if: github.ref == 'refs/tags/v0.50.88'"
contains "$recovery" 'gh workflow run homebrew-formula-bridge-recovery.yaml --ref v0.50.88'
not_contains "$release" "'v0.50.87'"
not_contains "$release" 'refs/tags/v0.50.87'
not_contains "$recovery" 'refs/tags/v0.50.87'
...
contains "$producer_receipt" "GITHUB_REF_NAME\" == 'v0.50.88'"
contains "$producer_receipt" "release_phase='A17'"
contains "$homebrew_bridge" "readonly RELEASE_TAG='v0.50.88'"
contains "$homebrew_bridge" "readonly RELEASE_VERSION='0.50.88'"
...
contains "$current_release_gate" "readonly RELEASE_TAG='v0.50.88'"
contains "$current_release_gate" "readonly RELEASE_VERSION='0.50.88'"
