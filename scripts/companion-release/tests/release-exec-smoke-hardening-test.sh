...
contains "$materializer" 'https://github.com/can1357/oh-my-pi/releases/download/v18.1.5/omp-darwin-arm64'
contains "$materializer" '7e6c52bee5f4f934a3f0af26691284f6b84b4f5ea3d73c8b748c2fc68d5c5c7f'
...
if [[ "$(uname -s)" == 'Darwin' ]]; then
  ...
  if [[ "$architecture" == 'arm64' ]]; then
    ...
    if [[ -n "$omp_executable" && \
      ...
      '7e6c52bee5f4f934a3f0af26691284f6b84b4f5ea3d73c8b748c2fc68d5c5c7f' ]]; then
