...
readonly A3_REPOSITORY='Insajin/autopus-adk' A3_TAG='v0.50.72' A3_VERSION='0.50.72'
readonly A4_TAG='v0.50.73' A4_VERSION='0.50.73'
...
readonly MANIFEST_SIGNATURE_NAME='adk-companion-manifest.sig' ARTIFACT_NAME='auto' CHECKSUMS_NAME='checksums.txt'
readonly A0_EVIDENCE_SOURCE='immutable A0 GitHub release' LOCAL_EVIDENCE_ERROR='fixture_or_local_evidence_forbidden'
