...
if [[ "$release_phase" == 'A15' || "$release_phase" == 'A16' || "$release_phase" == 'A17' || "$release_phase" == 'A18' || "$release_phase" == 'A19' || "$release_phase" == 'A20' || "$release_phase" == 'A21' || "$release_phase" == 'A22' || "$release_phase" == 'A24' || "$release_phase" == 'A25' || "$release_phase" == 'A26' || "$release_phase" == 'A27' || "$release_phase" == 'A28' ]]; then
...
if [[ "$release_phase" == 'A23' || "$release_phase" == 'A24' || "$release_phase" == 'A25' || "$release_phase" == 'A26' || "$release_phase" == 'A27' || "$release_phase" == 'A28' ]]; then
