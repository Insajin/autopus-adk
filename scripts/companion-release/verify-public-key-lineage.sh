...
elif [[ "$release_phase" == 'A2' || "$release_phase" == 'A3' || "$release_phase" == 'A4' || "$release_phase" == 'A5' || "$release_phase" == 'A6' || "$release_phase" == 'A7' || "$release_phase" == 'A8' || "$release_phase" == 'A9' || "$release_phase" == 'A10' || "$release_phase" == 'A11' || "$release_phase" == 'A12' || "$release_phase" == 'A13' || "$release_phase" == 'A14' || "$release_phase" == 'A15' || "$release_phase" == 'A16' || "$release_phase" == 'A17' || "$release_phase" == 'A18' || "$release_phase" == 'A19' || "$release_phase" == 'A20' || "$release_phase" == 'A21' || "$release_phase" == 'A22' || "$release_phase" == 'A24' || "$release_phase" == 'A25' ]]; then
...
if [[ "$release_phase" == 'A15' || "$release_phase" == 'A16' || "$release_phase" == 'A17' || "$release_phase" == 'A18' || "$release_phase" == 'A19' || "$release_phase" == 'A20' || "$release_phase" == 'A21' || "$release_phase" == 'A22' || "$release_phase" == 'A24' || "$release_phase" == 'A25' ]]; then
...
if [[ "$release_phase" == 'A23' || "$release_phase" == 'A24' || "$release_phase" == 'A25' ]]; then
