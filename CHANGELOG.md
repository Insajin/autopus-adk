...
- **v0.50.71 RC 릴리스 계보 통합 기반** (2026-07-16): 최신 `main`의 GPT Ultra 구현과 `v0.50.70`의 companion 릴리스 계보를 하나의 후손 커밋으로 통합한다. 이 단계는 기존 A0 `v0.50.69`와 A1 `v0.50.70`의 서명·공증·공개키 receipt 구현을 보존하는 통합 기반이며, A2 정책 구현·태그 생성·정책 promotion·Ultra compact 활성화·Desktop B0/R1 완료를 뜻하지 않는다.
