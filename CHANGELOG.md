...
- **v0.50.110 정상 보호 릴리즈 lane 복구** (2026-08-30): v0.50.109의 일회성 canonical-full 키 회전 bridge 다음 세대인 A23을 정상 15-asset 릴리즈로 전환했다. active static policy가 promotion K3 signer와 provider authority digest를 직접 소유하고 K1/K2는 historical proof에만 남긴다. R2 서명 태그, 최신 20-pair/40-call 증거, one-shot orphan evidence, zero-asset draft, tag ruleset의 armed→sealed 전환, immutable release 검증 뒤 Homebrew Cask CAS와 공개 v0.50.109→v0.50.110 canary 순서를 하나의 fail-closed transaction으로 고정했다.
