...
- Codex maps Balanced Opus-tier tasks to Sol/`xhigh`, Sonnet-tier tasks to Terra with role effort, and Haiku-tier tasks to Luna with role effort; Ultra managed workers use Sol/`max`
