...
Use the pack as metadata-only evidence for source availability, token/component refs, screenshot/golden refs, Figma refs, compact fetched Figma node metadata, and Code Connect readiness. Missing pack data is a setup gap, not an instruction to invent a new design system.
