...
Before Step 1, treat `.claude/rules/autopus/spec-quality.md` as the pre-review self-check that spec-writer should already have applied to `spec.md`, `plan.md`, `acceptance.md`, and `research.md`.
...
Confirm that the draft went through a first-pass self-check using `.claude/rules/autopus/spec-quality.md`.
