...
Claude Ultra, Balanced 전략 역할, high-complexity 라우팅은 고정 모델 ID
`claude-opus-5`를 사용합니다. Claude Code의 `opus` alias가 Opus 5를 선택하려면
...
Autopus는 Claude Code argv에 thinking-disable flag를 추가하지
