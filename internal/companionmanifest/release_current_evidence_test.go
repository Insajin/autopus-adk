...
var currentReleaseArchives = []string{
	"autopus-adk_0.50.88_darwin_amd64.tar.gz",
	"autopus-adk_0.50.88_darwin_arm64.tar.gz",
	"autopus-adk_0.50.88_linux_amd64.tar.gz",
	"autopus-adk_0.50.88_linux_arm64.tar.gz",
	"autopus-adk_0.50.88_windows_amd64.tar.gz",
	"autopus-adk_0.50.88_windows_amd64.zip",
	"autopus-adk_0.50.88_windows_arm64.tar.gz",
	"autopus-adk_0.50.88_windows_arm64.zip",
}
...
func newCurrentReleaseFixture(t *testing.T) *currentReleaseFixture {
	...
	fixture := &currentReleaseFixture{
		...
		release: currentReleaseDocument{
			TagName: "v0.50.88", TargetCommitish: strings.Repeat("c", 40),
...
case "$endpoint" in
  repos/Insajin/autopus-adk/releases/tags/v0.50.88)
