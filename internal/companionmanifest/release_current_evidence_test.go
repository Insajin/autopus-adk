...
var currentReleaseArchives = []string{
	"autopus-adk_0.50.81_darwin_amd64.tar.gz",
	"autopus-adk_0.50.81_darwin_arm64.tar.gz",
	"autopus-adk_0.50.81_linux_amd64.tar.gz",
	"autopus-adk_0.50.81_linux_arm64.tar.gz",
	"autopus-adk_0.50.81_windows_amd64.tar.gz",
	"autopus-adk_0.50.81_windows_amd64.zip",
	"autopus-adk_0.50.81_windows_arm64.tar.gz",
	"autopus-adk_0.50.81_windows_arm64.zip",
}
...
func newCurrentReleaseFixture(t *testing.T) *currentReleaseFixture {
	...
	fixture := &currentReleaseFixture{
		...
		release: currentReleaseDocument{
			TagName: "v0.50.81", TargetCommitish: strings.Repeat("c", 40),
...
case "$endpoint" in
  repos/Insajin/autopus-adk/releases/tags/v0.50.81)
