...
func TestLineageVerifier_A0BootstrapsWhileA1ThroughA29WithoutLiveEvidenceFailClosed(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "A28", tag: "v0.50.117", message: "missing GITHUB_TOKEN"},
		{name: "A29", tag: "v0.50.118", message: "missing GITHUB_TOKEN"},
