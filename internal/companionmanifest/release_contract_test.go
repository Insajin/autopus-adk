...
func TestReleaseWorkflow_ExactA13ProtectedEnvironmentAndImmutableActions(t *testing.T) {
	release := readReleaseFile(t, ".github/workflows/release.yaml")
	for _, required := range []string{
		"v0.50.84", "refs/tags/v0.50.84",
	...
	for _, forbidden := range []string{
		"'v0.50.69'", "'v0.50.70'", "'v0.50.71'", "'v0.50.72'", "'v0.50.73'", "'v0.50.74'", "'v0.50.75'", "'v0.50.76'", "'v0.50.77'", "'v0.50.78'", "'v0.50.79'", "'v0.50.80'", "'v0.50.81'", "'v0.50.82'", "'v0.50.83'",
		"refs/tags/v0.50.69", "refs/tags/v0.50.70", "refs/tags/v0.50.71", "refs/tags/v0.50.72", "refs/tags/v0.50.73", "refs/tags/v0.50.74", "refs/tags/v0.50.75", "refs/tags/v0.50.76", "refs/tags/v0.50.77", "refs/tags/v0.50.78", "refs/tags/v0.50.79", "refs/tags/v0.50.80", "refs/tags/v0.50.81", "refs/tags/v0.50.82", "refs/tags/v0.50.83",
	} {
		if strings.Contains(release, forbidden) {
			t.Fatalf("historical tag %q can enter the A13 release workflow", forbidden)
		}
	}
...
func TestReleaseWorkflow_HomebrewFormulaBridgeRunsAfterPublishBeforeCleanup(t *testing.T) {
	...
	for _, exact := range []string{
		"GITHUB_REF_NAME='v0.50.84'",
		"COMPANION_VERSION='0.50.84'",
