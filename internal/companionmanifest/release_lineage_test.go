...
func TestReleaseSourceValidator_RejectsCoordinateMismatchAndOutsidePolicy(t *testing.T) {
	...
	for _, test := range []struct{ name, tag, sha, message string }{
		...
		{name: "failed_A6_tag_75", tag: "v0.50.75", sha: headSHA, message: "outside the frozen A0/A1/A2/A3/A4/A5/A6/A7 policy"},
		{name: "failed_A6_tag_76", tag: "v0.50.76", sha: headSHA, message: "outside the frozen A0/A1/A2/A3/A4/A5/A6/A7 policy"},
		{name: "outside", tag: "v0.50.79", sha: headSHA, message: "outside the frozen A0/A1/A2/A3/A4/A5/A6/A7 policy"},
	} {
...
func TestLineageVerifier_A0BootstrapsWhileA1ThroughA7WithoutLiveEvidenceFailClosed(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "failed_A6_tag_75", tag: "v0.50.75", message: "outside the frozen A0/A1/A2/A3/A4/A5/A6/A7 policy"},
		{name: "failed_A6_tag_76", tag: "v0.50.76", message: "outside the frozen A0/A1/A2/A3/A4/A5/A6/A7 policy"},
		{name: "outside", tag: "v0.50.79", message: "outside the frozen A0/A1/A2/A3/A4/A5/A6/A7 policy"},
	}
