...
//
//go:embed claude/commands/*.tmpl claude/skills/*.tmpl claude/*.tmpl claude/rules/*.tmpl codex/skills/*.tmpl codex/prompts/*.tmpl codex/agents/*.tmpl codex/rules/autopus/*.tmpl codex/*.tmpl gemini/agents/*.tmpl gemini/skills/*/*.tmpl gemini/commands/auto/*.tmpl gemini/rules/autopus/*.tmpl gemini/settings/*.tmpl hooks/*.tmpl shared/*.tmpl
var FS embed.FS
