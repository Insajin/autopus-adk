...
func desktopGUIStarter(signals projectSignals) starterFile {
	return starterFile{
		...
		Body: fmt.Sprintf(`# Generated by auto qa init. Review before executing.
...
source_refs:
  ...
  do_not_modify_paths:
    ...
    - .opencode/**
    - .autopus/plugins/**
`, renderInlineStrings(jsRunnerArgv(nodeCommand(signals.PackageManager), "playwright", "test"))),
	}
}
