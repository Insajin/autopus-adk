...
func directPredecessorPinReplacements(fixture *executableLineageFixture) map[string]string {
	...
	if prefix == "A14" || prefix == "A15" || prefix == "A16" {
	...
	if prefix == "A7" || prefix == "A8" || prefix == "A9" || prefix == "A10" || prefix == "A11" || prefix == "A12" || prefix == "A13" || prefix == "A14" || prefix == "A15" || prefix == "A16" {
...
func immutableProductionLineagePin(name string) (string, bool) {
	for _, pins := range []map[string]string{
		...
		immutableA15LineagePins, immutableA16LineagePins,
	} {
