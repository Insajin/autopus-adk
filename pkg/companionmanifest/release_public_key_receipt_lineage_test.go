...
func TestReleasePublicKeyReceipt_A0Policy_IsOneExactAuditableBootstrap(t *testing.T) {
	...
	for _, exact := range []string{
		...
		"release_phase='A2'",
		"release_phase='A3'",
		"release_phase='A4'", "release_phase='A5'", "release_phase='A6'", "release_phase='A7'", "release_phase='A8'", "release_phase='A9'", "release_phase='A10'", "release_phase='A11'", "release_phase='A12'", "release_phase='A13'", "release_phase='A14'", "release_phase='A15'", "release_phase='A16'", "release_phase='A17'", "release_phase='A18'", "release_phase='A19'", "release_phase='A20'",
	} {
...
func TestReleasePublicKeyReceipt_NonBootstrapPriorEvidence_VerifiesDirectPredecessorAndCurrentEquality(t *testing.T) {
	...
	requirePublicKeyReceiptLineagePhaseFailure(t, "v0.50.92", "prior_release_identity_mismatch")
