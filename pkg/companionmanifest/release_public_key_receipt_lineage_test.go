...
func TestReleasePublicKeyReceipt_A0Policy_IsOneExactAuditableBootstrap(t *testing.T) {
	...
	for _, exact := range []string{
		...
		"release_phase='A2'",
		"release_phase='A3'",
		"release_phase='A4'", "release_phase='A5'", "release_phase='A6'", "release_phase='A7'", "release_phase='A8'",
	} {
...
func TestReleasePublicKeyReceipt_NonBootstrapPriorEvidence_VerifiesDirectPredecessorAndCurrentEquality(t *testing.T) {
	...
	for _, required := range []string{
		...
		publicKeyReceiptA6Tag, publicKeyReceiptA7Tag, publicKeyReceiptA8Tag,
	...
	requirePublicKeyReceiptLineagePhaseFailure(t, "v0.50.80", "prior_release_identity_mismatch")
