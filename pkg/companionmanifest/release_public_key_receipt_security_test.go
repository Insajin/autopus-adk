...
func TestReleasePublicKeyReceipt_Workflow_SecretsAreStepScopedAndCleanupFailuresObserved(t *testing.T) {
	...
	_, sourceStep := releaseWorkflowStepContaining(t, workflow, "Validate exact protected release source")
...
func publicKeyReceiptAllowedStepEnv() map[string]struct{} {
	names := []string{
		...
		"COMPANION_SOURCE_COMMIT", "COMPANION_SOURCE_TREE", "COMPANION_RELEASE_ID",
		"COMPANION_CHECKSUMS_PATH", "COMPANION_SIGNER", "COMPANION_MANIFEST_VERIFIER",
		...
		"AUTOPUS_ADK_CHANNEL_KEY_ID", "AUTOPUS_ADK_CHANNEL_PUBLIC_KEY",
		"EXPECTED_AUTHORITY_COMMIT", "CANDIDATE_AUTHORITY_COMMIT", "PROTECTED_AUTHORITY_COMMIT",
		"EXPECTED_ROTATION_REF_COMMIT", "EXPECTED_ROTATION_DOCUMENT_SHA256",
		...
		"OMP_CONTEXT_STATIC_POLICY_SHA256", "OMP_CONTEXT_PROMOTION_REPORT_PATH",
		"OMP_CONTEXT_PROMOTION_ATTESTATION_PATH",
		"ROTATION_REF_COMMIT", "ROTATION_DOCUMENT_SHA256",
		"ADK_KEY_ROTATION_REF_COMMIT", "ADK_KEY_ROTATION_DOCUMENT_SHA256",
		"ADK_KEY_ROTATION_DOCUMENT_PATH", "ADK_KEY_ROTATION_SIGNATURE_PATH",
		"ADK_KEY_ROTATION_VERIFIER", "OMP_CONTEXT_BRIDGE_MANIFEST_PATH",
