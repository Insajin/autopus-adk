// Package antigravity provides skill template rendering for Antigravity CLI.
package antigravity
...
// renderSkillTemplates reads Antigravity skill templates from the embedded FS,
// renders them, writes to .gemini/skills/autopus/{skill}/SKILL.md, and
// returns file mappings.
func (a *Adapter) renderSkillTemplates(cfg *config.HarnessConfig, antigravitySkillBaseDir string) ([]adapter.FileMapping, error) {
