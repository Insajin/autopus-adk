...
func TestE2EInitCodex(t *testing.T) {
	...
	// .codex/prompts/ directory must exist with QAMESH and goal prompts included.
	assertDirHasNFiles(t, filepath.Join(dir, ".codex", "prompts"), 19)
...
func TestE2ECodex_FileCount(t *testing.T) {
	...
	assert.Equal(t, 19, prompts, "should have 19 prompt files")
