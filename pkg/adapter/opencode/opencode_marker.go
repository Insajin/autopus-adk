...
{{if contains (join ", " .Platforms) "codex"}}- Codex Native Skills: .codex/skills/codex-<name>/SKILL.md
...
{{end}}{{if contains (join ", " .Platforms) "codex"}}- OpenCode-owned Shared Skills: .agents/skills/
