...
func TestRenderPromptTemplates_WorkflowContractsPresent(t *testing.T) {
	...
	assert.Contains(t, byName["auto-idea.md"], "Blocked decision")
	assert.Contains(t, byName["auto-idea.md"], "Recommended answer")
	...
	assert.Contains(t, byName["auto-idea.md"], "Outcome Lock")
	assert.Contains(t, byName["auto-idea.md"], "Evolution Ideas")
	assert.Contains(t, byName["auto-idea.md"], "Debate focus")
	assert.Contains(t, byName["auto-idea.md"], "Visual Brief")
	assert.Contains(t, byName["auto-idea.md"], "wireframe")
	...
	assert.Contains(t, byName["auto-plan.md"], "explicit non-goals")
	assert.Contains(t, byName["auto-plan.md"], "Outcome Lock")
	assert.Contains(t, byName["auto-plan.md"], "Completion Debt")
	assert.Contains(t, byName["auto-plan.md"], "Evolution Ideas")
	assert.Contains(t, byName["auto-plan.md"], "Sibling SPEC Decision")
	assert.Contains(t, byName["auto-plan.md"], "Visual Planning Brief")
	assert.Contains(t, byName["auto-plan.md"], "Mermaid `flowchart`")
	assert.Contains(t, byName["auto-status.md"], "auto status")
	assert.Contains(t, byName["auto-goal.md"], "Codex Goal Wrapper")
	assert.Contains(t, byName["auto-goal.md"], "`/goal` thread 기능")
	assert.Contains(t, byName["auto-goal.md"], "create_goal")
	...
	assert.Contains(t, byName["auto-sync.md"], "## Completion Verdict")
	assert.Contains(t, byName["auto-sync.md"], "Evolution Ideas: surfaced as optional, not scheduled")
	...
	assert.Contains(t, byName["auto-qa.md"], "auto qa feedback")
