...
func TestClaudeSkillCompiler_FullSplitFullPrunesOnlyOwnedLongTail(t *testing.T) {
	...
	core := filepath.Join(root, ".claude", "skills", "autopus", "planning.md")
	workflow := filepath.Join(root, ".claude", "skills", "autopus", "auto-go.md")
	longTail := filepath.Join(root, ".claude", "skills", "autopus", "metrics.md")
...
func TestClaudeSkillCompiler_RejectsSymlinkedManagedRootDuringPrune(t *testing.T) {
	...
	managedRoot := filepath.Join(root, ".claude", "skills", "autopus")
